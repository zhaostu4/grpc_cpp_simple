...
public:
    ...
    std::string Test3(const std::string& name, const int clientId, const double externValue) {
        ...
        std::unique_ptr<ClientAsyncResponseReader<Simple::TestReply> > rpc(
                stub_->PrepareAsyncTest3(&context, request, &cq));
...
int main(int argc, char** argv) {
    ...
    for(int i=0; i<20; i++){
        std::string reply = client.Test3("zhao", i+10, i);  // The actual RPC call!
